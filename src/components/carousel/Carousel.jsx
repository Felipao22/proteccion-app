...
export default function Carrusel() {
  return (
    <Carousel interval={3000}>
      <Carousel.Item>
        <img className="d-block w-100" src={pro} alt="First slide" />
      </Carousel.Item>
      <Carousel.Item>
        ...
        <img className="d-block w-100" src={exit} alt="Second slide" />
      </Carousel.Item>
      <Carousel.Item>
        <img className="img-overlay" src={logoBlanco} alt="log" />
        <div className="box-text">
        ...
        <img className="d-block w-100" src={im1} alt="Third slide" />
      </Carousel.Item>
    </Carousel>
  );
}
